...
import (
	...
	eventsv1 "zntr.io/spotigraph/api/gen/go/spotigraph/system/v1"
)

//go:generate mockgen -destination mock/publisher.gen.go -package mock zntr.io/spotigraph/infrastructure/publisher Publisher
