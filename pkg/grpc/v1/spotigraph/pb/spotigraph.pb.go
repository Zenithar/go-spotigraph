...
func init() {
	proto.RegisterFile("pkg/grpc/v1/spotigraph/pb/spotigraph.proto", fileDescriptor_spotigraph_6812c2fd2c96878f)
}

var fileDescriptor_spotigraph_6812c2fd2c96878f = []byte{
