...
func init() {
	proto.RegisterFile("pkg/grpc/v1/spotigraph/pb/spotigraph.proto", fileDescriptor_spotigraph_f26db4b921a4b1ca)
}

var fileDescriptor_spotigraph_f26db4b921a4b1ca = []byte{
