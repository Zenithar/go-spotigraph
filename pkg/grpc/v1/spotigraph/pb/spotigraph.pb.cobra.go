...
var user_CreateClientCommand = &cobra.Command{
	Use:  "create",
...
func init() {
	UserClientCommand.AddCommand(user_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(user_CreateClientCommand.Flags())
}

var user_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	UserClientCommand.AddCommand(user_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(user_GetClientCommand.Flags())
}

var user_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	UserClientCommand.AddCommand(user_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(user_UpdateClientCommand.Flags())
}

var user_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
var squad_CreateClientCommand = &cobra.Command{
	Use:  "create",
	Long: "Create client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	SquadClientCommand.AddCommand(squad_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(squad_CreateClientCommand.Flags())
}

var squad_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	SquadClientCommand.AddCommand(squad_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(squad_GetClientCommand.Flags())
}

var squad_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	SquadClientCommand.AddCommand(squad_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(squad_UpdateClientCommand.Flags())
}

var squad_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
var chapter_CreateClientCommand = &cobra.Command{
	Use:  "create",
	Long: "Create client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	ChapterClientCommand.AddCommand(chapter_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(chapter_CreateClientCommand.Flags())
}

var chapter_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	ChapterClientCommand.AddCommand(chapter_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(chapter_GetClientCommand.Flags())
}

var chapter_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	ChapterClientCommand.AddCommand(chapter_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(chapter_UpdateClientCommand.Flags())
}

var chapter_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
var guild_CreateClientCommand = &cobra.Command{
	Use:  "create",
	Long: "Create client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	GuildClientCommand.AddCommand(guild_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(guild_CreateClientCommand.Flags())
}

var guild_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	GuildClientCommand.AddCommand(guild_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(guild_GetClientCommand.Flags())
}

var guild_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	GuildClientCommand.AddCommand(guild_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(guild_UpdateClientCommand.Flags())
}

var guild_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
var tribe_CreateClientCommand = &cobra.Command{
	Use:  "create",
	Long: "Create client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	TribeClientCommand.AddCommand(tribe_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(tribe_CreateClientCommand.Flags())
}

var tribe_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	TribeClientCommand.AddCommand(tribe_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(tribe_GetClientCommand.Flags())
}

var tribe_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	TribeClientCommand.AddCommand(tribe_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(tribe_UpdateClientCommand.Flags())
}

var tribe_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
