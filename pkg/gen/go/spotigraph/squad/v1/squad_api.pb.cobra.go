...
var SquadAPIClientCommand = &cobra.Command{
	Use: "squadAPI",
}

var squadAPI_CreateClientCommand = &cobra.Command{
	Use:  "create",
...
Authenticate using the Authorization header (requires transport security):
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		grpcClient := NewSquadAPIClient(conn)
...
func init() {
	SquadAPIClientCommand.AddCommand(squadAPI_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(squadAPI_CreateClientCommand.Flags())
}

var squadAPI_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	SquadAPIClientCommand.AddCommand(squadAPI_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(squadAPI_GetClientCommand.Flags())
}

var squadAPI_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	SquadAPIClientCommand.AddCommand(squadAPI_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(squadAPI_UpdateClientCommand.Flags())
}

var squadAPI_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	SquadAPIClientCommand.AddCommand(squadAPI_DeleteClientCommand)
	DefaultClientCommandConfig.AddFlags(squadAPI_DeleteClientCommand.Flags())
}

var squadAPI_SearchClientCommand = &cobra.Command{
	Use:  "search",
	Long: "Search client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	SquadAPIClientCommand.AddCommand(squadAPI_SearchClientCommand)
	DefaultClientCommandConfig.AddFlags(squadAPI_SearchClientCommand.Flags())
}

var squadAPI_JoinClientCommand = &cobra.Command{
	Use:  "join",
	Long: "Join client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	SquadAPIClientCommand.AddCommand(squadAPI_JoinClientCommand)
	DefaultClientCommandConfig.AddFlags(squadAPI_JoinClientCommand.Flags())
}

var squadAPI_LeaveClientCommand = &cobra.Command{
	Use:  "leave",
	Long: "Leave client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	SquadAPIClientCommand.AddCommand(squadAPI_LeaveClientCommand)
	DefaultClientCommandConfig.AddFlags(squadAPI_LeaveClientCommand.Flags())
}
