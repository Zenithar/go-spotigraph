...
var ChapterAPIClientCommand = &cobra.Command{
	Use: "chapterAPI",
}

var chapterAPI_CreateClientCommand = &cobra.Command{
	Use:  "create",
...
func init() {
	ChapterAPIClientCommand.AddCommand(chapterAPI_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(chapterAPI_CreateClientCommand.Flags())
}

var chapterAPI_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	ChapterAPIClientCommand.AddCommand(chapterAPI_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(chapterAPI_GetClientCommand.Flags())
}

var chapterAPI_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	ChapterAPIClientCommand.AddCommand(chapterAPI_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(chapterAPI_UpdateClientCommand.Flags())
}

var chapterAPI_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	ChapterAPIClientCommand.AddCommand(chapterAPI_DeleteClientCommand)
	DefaultClientCommandConfig.AddFlags(chapterAPI_DeleteClientCommand.Flags())
}

var chapterAPI_SearchClientCommand = &cobra.Command{
	Use:  "search",
	Long: "Search client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
