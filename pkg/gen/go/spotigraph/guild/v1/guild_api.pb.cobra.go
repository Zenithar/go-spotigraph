...
var GuildAPIClientCommand = &cobra.Command{
	Use: "guildAPI",
}

var guildAPI_CreateClientCommand = &cobra.Command{
	Use:  "create",
...
Authenticate using the Authorization header (requires transport security):
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		grpcClient := NewGuildAPIClient(conn)
...
func init() {
	GuildAPIClientCommand.AddCommand(guildAPI_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(guildAPI_CreateClientCommand.Flags())
}

var guildAPI_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	GuildAPIClientCommand.AddCommand(guildAPI_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(guildAPI_GetClientCommand.Flags())
}

var guildAPI_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	GuildAPIClientCommand.AddCommand(guildAPI_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(guildAPI_UpdateClientCommand.Flags())
}

var guildAPI_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	GuildAPIClientCommand.AddCommand(guildAPI_DeleteClientCommand)
	DefaultClientCommandConfig.AddFlags(guildAPI_DeleteClientCommand.Flags())
}

var guildAPI_SearchClientCommand = &cobra.Command{
	Use:  "search",
	Long: "Search client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	GuildAPIClientCommand.AddCommand(guildAPI_SearchClientCommand)
	DefaultClientCommandConfig.AddFlags(guildAPI_SearchClientCommand.Flags())
}

var guildAPI_JoinClientCommand = &cobra.Command{
	Use:  "join",
	Long: "Join client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	GuildAPIClientCommand.AddCommand(guildAPI_JoinClientCommand)
	DefaultClientCommandConfig.AddFlags(guildAPI_JoinClientCommand.Flags())
}

var guildAPI_LeaveClientCommand = &cobra.Command{
	Use:  "leave",
	Long: "Leave client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	GuildAPIClientCommand.AddCommand(guildAPI_LeaveClientCommand)
	DefaultClientCommandConfig.AddFlags(guildAPI_LeaveClientCommand.Flags())
}
