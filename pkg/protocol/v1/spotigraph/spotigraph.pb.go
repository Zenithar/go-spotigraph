...
func init() {
	proto.RegisterFile("pkg/protocol/v1/spotigraph/spotigraph.proto", fileDescriptor_spotigraph_ff04991e18278b8c)
}

var fileDescriptor_spotigraph_ff04991e18278b8c = []byte{
