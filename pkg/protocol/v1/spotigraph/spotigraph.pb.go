...
type SquadUpdateReq struct {
	...
	ProductOwnerId *google_protobuf3.StringValue `protobuf:"bytes,3,opt,name=product_owner_id,json=productOwnerId" json:"product_owner_id,omitempty"`
}
...
func (m *SquadUpdateReq) GetProductOwnerId() *google_protobuf3.StringValue {
	if m != nil {
...
type ChapterUpdateReq struct {
	Id       string                        `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Name     *google_protobuf3.StringValue `protobuf:"bytes,2,opt,name=name" json:"name,omitempty"`
	LeaderId *google_protobuf3.StringValue `protobuf:"bytes,3,opt,name=leader_id,json=leaderId" json:"leader_id,omitempty"`
}
...
func (m *ChapterUpdateReq) GetLeaderId() *google_protobuf3.StringValue {
	if m != nil {
		return m.LeaderId
	}
	return nil
...
func NewPopulatedSquadUpdateReq(r randySpotigraph, easy bool) *SquadUpdateReq {
	...
	if r.Intn(10) != 0 {
		this.ProductOwnerId = google_protobuf3.NewPopulatedStringValue(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedChapterUpdateReq(r randySpotigraph, easy bool) *ChapterUpdateReq {
	...
	if r.Intn(10) != 0 {
		this.LeaderId = google_protobuf3.NewPopulatedStringValue(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *SquadUpdateReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.ProductOwnerId == nil {
				m.ProductOwnerId = &google_protobuf3.StringValue{}
			}
...
func (m *ChapterUpdateReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.LeaderId == nil {
				m.LeaderId = &google_protobuf3.StringValue{}
			}
