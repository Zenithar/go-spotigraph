...
type SquadUpdateReq struct {
	...
	ProductOwnerId       *types.StringValue `protobuf:"bytes,3,opt,name=product_owner_id,json=productOwnerId,proto3" json:"product_owner_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *SquadMemberReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SquadMemberReq.Merge(m, src)
}
...
func (*GraphRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_7b21dc3dbc5bac63, []int{36}
}
