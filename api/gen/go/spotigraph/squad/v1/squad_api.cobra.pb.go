...
var _DefaultSquadAPIClientCommandConfig = _NewSquadAPIClientCommandConfig()

type _SquadAPIClientCommandConfig struct {
	ServerAddr         string
	RequestFile        string
	Stdin              bool
...
func _NewSquadAPIClientCommandConfig() *_SquadAPIClientCommandConfig {
	c := &_SquadAPIClientCommandConfig{
...
func (o *_SquadAPIClientCommandConfig) AddFlags(fs *pflag.FlagSet) {
...
func SquadAPIClientCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use: "squadapi",
	}
	_DefaultSquadAPIClientCommandConfig.AddFlags(cmd.PersistentFlags())

	for _, s := range _SquadAPIClientSubCommands {
		cmd.AddCommand(s())
	}
	return cmd
}

func _DialSquadAPI() (*grpc.ClientConn, SquadAPIClient, error) {
	cfg := _DefaultSquadAPIClientCommandConfig
	...
	return conn, NewSquadAPIClient(conn), nil
}

type _SquadAPIRoundTripFunc func(cli SquadAPIClient, in iocodec.Decoder, out iocodec.Encoder) error

func _SquadAPIRoundTrip(sample interface{}, fn _SquadAPIRoundTripFunc) error {
	cfg := _DefaultSquadAPIClientCommandConfig
...
func _SquadAPICreateClientCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			var v CreateRequest
			err := _SquadAPIRoundTrip(v, func(cli SquadAPIClient, in iocodec.Decoder, out iocodec.Encoder) error {
...
func _SquadAPIGetClientCommand() *cobra.Command {
	reqArgs := &GetRequest{}
...
func _SquadAPIUpdateClientCommand() *cobra.Command {
...
func _SquadAPIDeleteClientCommand() *cobra.Command {
...
func _SquadAPISearchClientCommand() *cobra.Command {
...
func _SquadAPIJoinClientCommand() *cobra.Command {
	reqArgs := &JoinRequest{}
	...
	cmd.PersistentFlags().StringVar(&reqArgs.SquadId, "squadid", "", "get-comment-from-proto")

	return cmd
}

func _SquadAPILeaveClientCommand() *cobra.Command {
...
var _SquadAPIClientSubCommands = []func() *cobra.Command{
	_SquadAPICreateClientCommand,
	_SquadAPIGetClientCommand,
	_SquadAPIUpdateClientCommand,
	_SquadAPIDeleteClientCommand,
	_SquadAPISearchClientCommand,
	_SquadAPIJoinClientCommand,
	_SquadAPILeaveClientCommand,
}
