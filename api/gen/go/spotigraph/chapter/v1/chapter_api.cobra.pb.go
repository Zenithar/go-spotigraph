...
var _DefaultChapterAPIClientCommandConfig = _NewChapterAPIClientCommandConfig()

type _ChapterAPIClientCommandConfig struct {
	ServerAddr         string
	RequestFile        string
	Stdin              bool
...
func _NewChapterAPIClientCommandConfig() *_ChapterAPIClientCommandConfig {
	c := &_ChapterAPIClientCommandConfig{
...
func (o *_ChapterAPIClientCommandConfig) AddFlags(fs *pflag.FlagSet) {
...
func ChapterAPIClientCommand() *cobra.Command {
	cmd := &cobra.Command{
		Use: "chapterapi",
	}
	_DefaultChapterAPIClientCommandConfig.AddFlags(cmd.PersistentFlags())

	for _, s := range _ChapterAPIClientSubCommands {
		cmd.AddCommand(s())
	}
	return cmd
}

func _DialChapterAPI() (*grpc.ClientConn, ChapterAPIClient, error) {
	cfg := _DefaultChapterAPIClientCommandConfig
	...
	return conn, NewChapterAPIClient(conn), nil
}

type _ChapterAPIRoundTripFunc func(cli ChapterAPIClient, in iocodec.Decoder, out iocodec.Encoder) error

func _ChapterAPIRoundTrip(sample interface{}, fn _ChapterAPIRoundTripFunc) error {
	cfg := _DefaultChapterAPIClientCommandConfig
	...
	conn, client, err := _DialChapterAPI()
	if err != nil {
		return err
	}
	defer conn.Close()
...
func _ChapterAPICreateClientCommand() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&reqArgs.LeaderId, "leaderid", "", "get-comment-from-proto")

	return cmd
}

func _ChapterAPIGetClientCommand() *cobra.Command {
	reqArgs := &GetRequest{}
...
func _ChapterAPIUpdateClientCommand() *cobra.Command {
...
func _ChapterAPIDeleteClientCommand() *cobra.Command {
...
func _ChapterAPISearchClientCommand() *cobra.Command {
...
func _ChapterAPIJoinClientCommand() *cobra.Command {
	reqArgs := &JoinRequest{}
	...
	cmd.PersistentFlags().StringVar(&reqArgs.ChapterId, "chapterid", "", "get-comment-from-proto")

	return cmd
}

func _ChapterAPILeaveClientCommand() *cobra.Command {
...
var _ChapterAPIClientSubCommands = []func() *cobra.Command{
	_ChapterAPICreateClientCommand,
	_ChapterAPIGetClientCommand,
	_ChapterAPIUpdateClientCommand,
	_ChapterAPIDeleteClientCommand,
	_ChapterAPISearchClientCommand,
	_ChapterAPIJoinClientCommand,
	_ChapterAPILeaveClientCommand,
}
