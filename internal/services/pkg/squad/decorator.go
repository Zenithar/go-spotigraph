...
func NewWithDecorators(squads repositories.Squad, users repositories.User, memberships repositories.Membership, decorators ...Decorator) services.Squad {
	// Initialize base
	s := New(squads, users, memberships)
